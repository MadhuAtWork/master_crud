var clients=[];
  var myIndex;
   function addClient(){
    ...
    var newClient={
      ...
      mcl:document.getElementById("mcl").value
    }	
  ...
  function displayClients(){
    ...
    for (i=0;i<clients.length;i++){
      ...
      document.getElementById("mc_branch").value="";
      document.getElementById("mcl").value="";
  }
  ...
  function editClient(i){
    ...
    document.getElementById("mc_name").value=clients[i].name
    document.getElementById("mc_code").value=clients[i].code
    document.getElementById("mc_branch").value=clients[i].branch
    document.getElementById("mcl").value=clients[i].mcl
  }
